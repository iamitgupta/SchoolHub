    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_st.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(search_admission.this, view_admission.class);
                intent.putExtra("st_username",st_username);
                Toast.makeText(getBaseContext(), "Selected " +st_username, Toast.LENGTH_LONG).show();
